...
* **[NBlood](https://github.com/NBlood/NBlood) ⭐ 793 | 🐛 114 | 🌐 C++ | 📅 2026-08-15** - Reverse-engineered ports of Build games using EDuke32 engine technology and development principles (NBlood/Rednukem/PCExhume d) [\[source\]](https://github.com/NBlood/NBlood) ⭐ 793 | 🐛 114 | 🌐 C++ | 📅 2026-08-15
...
* **Super Mario 64** - A full decompilation of [Super Mario 64](https://en.wikipedia.org/wiki/Super_Mario_64). [\[source\]](https://github.com/n64decomp/sm64) ⭐ 8,723 | 🐛 28 | 🌐 C | 📅 2024-02-04
...
* **[Yorg](https://ya2.itch.io/yorg)** - Yorg (Yorg's an Open Racing Game) is a free open source racing game developed by Ya2 using Panda3D for Windows, OSX and Linux. [\[source\]](https://github.com/cflavio/yorg) ⭐ 186 | 🐛 11 | 🌐 Python | 📅 2024-09-06 **Engine: [Panda3D](https://www.panda3d.org)** [\[source\]](https://github.com/panda3d/panda3d) ⭐ 5,205 | 🐛 367 | 🌐 C++ | 📅 2026-07-28
...
* **Minosoft** - An open source minecraft client, written from scratch in Kotlin (and java). [\[source\]](https://github.com/bixilon/minosoft) ⭐ 1,278 | 🐛 7 | 🌐 Kotlin | 📅 2026-06-28 [\[source\]](https://gitlab.bixilon.de/bixilon/minosoft)
